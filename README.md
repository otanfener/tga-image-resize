...
In the following sections, a brief background for the TGA image format and the resizing algorithm will be explained. After that, the implementation section will
