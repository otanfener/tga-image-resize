        ...
        case 1:
            for(auto ix = 0; ix < t.m_Header.Height; ix += 2){
                for (auto iy = 0; iy < t.m_Header.Width; iy += 2) {
                    ...
                    interpolatedPixelB = (inputImage[jump]+inputImage[t.Move(jump, 'R')]+inputImage[t.Move(jump, 'D')]+inputImage[t.Move(jump, 'X')])/4;
        ...
        case 2:
            for(auto ix = 0; ix < t.m_Header.Height; ix += 2){
                for (auto iy = 0; iy < t.m_Header.Width; iy += 2) {
                    ...
                    interpolatedPixelB = (inputImage[jump]+inputImage[t.Move(jump, 'R')]+inputImage[t.Move(jump, 'D')]+inputImage[t.Move(jump, 'X')])/4;
                    outputImage.push_back(interpolatedPixelB);
                    interpolatedPixelG = (inputImage[jump + 1]+inputImage[t.Move(jump + 1, 'R')]+inputImage[t.Move(jump + 1, 'D')]+inputImage[t.Move(jump + 1, 'X')])/4;
        ...
        case 3:
            for(auto ix = 0; ix < t.m_Header.Height; ix += 2){
                for (auto iy = 0; iy < t.m_Header.Width; iy += 2) {
                    ...
                    interpolatedPixelG = (inputImage[jump + 1]+inputImage[t.Move(jump + 1, 'R')]+inputImage[t.Move(jump + 1, 'D')]+inputImage[t.Move(jump + 1, 'X')])/4;
                    outputImage.push_back(interpolatedPixelG);
                    interpolatedPixelR = (inputImage[jump + 2]+inputImage[t.Move(jump + 2, 'R')]+inputImage[t.Move(jump + 2, 'D')]+inputImage[t.Move(jump + 2, 'X')])/4;
        ...
        case 4:
            for(auto ix = 0; ix < t.m_Header.Height; ix += 2){
                for (auto iy = 0; iy < t.m_Header.Width; iy += 2) {
                    ...
                    interpolatedPixelR = (inputImage[jump + 2]+inputImage[t.Move(jump + 2, 'R')]+inputImage[t.Move(jump + 2, 'D')]+inputImage[t.Move(jump + 2, 'X')])/4;
                    outputImage.push_back(interpolatedPixelR);
                    interpolatedPixelA = (inputImage[jump + 3]+inputImage[t.Move(jump + 3, 'R')]+inputImage[t.Move(jump + 3, 'D')]+inputImage[t.Move(jump + 3, 'X')])/4;
